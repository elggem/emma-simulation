...
Original source: https://github.com/open-dynamic-robot-initiative/robot_properties_bolt/blob/master/demos/demo_simulate_bolt.py
...
if __name__ == "__main__":
    ...
    env = BulletEnvWithGround(p.GUI) # DIRECT for non-gui
